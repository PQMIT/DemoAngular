...
var ToastItem = class _ToastItem extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    dependencies: () => [NgClass, NgIf, NgTemplateOutlet, CheckIcon, InfoCircleIcon, TimesCircleIcon, ExclamationTriangleIcon, TimesIcon, Button],
    encapsulation: 2,
    data: {
...
var ToastModule = class _ToastModule {
  ...
  static ɵinj = ɵɵdefineInjector({
    imports: [CommonModule, RippleModule, CheckIcon, InfoCircleIcon, TimesCircleIcon, ExclamationTriangleIcon, TimesIcon, ButtonModule, SharedModule]
  });
};
(() => {
